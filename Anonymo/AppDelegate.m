...
@synthesize idUser, coordonataUser;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.posteazaAnonim = [defaults boolForKey:@"posteazaAnonim"];
   ...
   // [messageVC setTabBarItem:[[UITabBarItem alloc] initWithTabBarSystemItem:
    ...
    UINavigationController *eventsVCNav = [[UINavigationController alloc] initWithRootViewController:eventsVC];
    //MissingView
    ...
    [self.tabController setViewControllers:[NSArray arrayWithObjects: eventsVCNav, mapVCNav, messageVCNav, settingsVCNav, nil]];
