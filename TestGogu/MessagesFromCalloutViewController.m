...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //author name
    NSString *messageID = [[date objectAtIndex:indexPath.row] objectForKey:@"userId"];
    BOOL b = [[rowRequest objectAtIndex:indexPath.row] boolValue];
    if(!b)
    {
    [httpRequests getUserWithID:messageID success:^(id data) {
    ...
    cell.detailsLabel.text = [NSString stringWithFormat:@"%@ send by %@", formattedDateString, authorName];
